...
def initial_processing(num_clips, min_start_time):
    ...
    highlights = find_highlights(
        "audio.mp4", "transcript_processed.json", num_clips, min_start_time
    )
    combine_clips(
        ["input1.mp4", "input2.mp4", "input3.mp4", "input4.mp4", "input5.mp4"],
        highlights,
        "output_highlights.mp4",
    )
...
def manual_highlight_processing(highlights):
    """Processing the video for just the highlights"""
    combine_clips(
        ["input1.mp4", "input2.mp4", "input3.mp4", "input4.mp4", "input5.mp4"],
        highlights,
        "output_highlights.mp4",
